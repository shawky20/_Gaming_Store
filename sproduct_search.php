...
if($conn->connect_error){
    ...
    //query to get the product using ID 
    $sql2 =  "SELECT name,price,brand,sale,Description,dimensions,color,count_in_stock,ID,Item_package_weight,img  FROM buy WHERE ID='  ".$id." '";
    
    
         if($catg==1){
            // playstation
            $sql3 =  'SELECT name,price,brand,sale,Description,dimensions,color,count_in_stock,ID,Item_package_weight,img FROM buy WHERE category="playstation"';
            
        }
        else if($catg==2){
            $sql3 =  'SELECT name,price,brand,sale,Description,dimensions,color,count_in_stock,ID,Item_package_weight,img  FROM buy WHERE category="Xbox"';
            
        }
        else if($catg==3){
            $sql3 =  'SELECT name,price,brand,sale,Description,dimensions,color,count_in_stock,ID,Item_package_weight,img  FROM buy WHERE category="console"';
           
        }
        else if($catg==4){
            $sql3 =  'SELECT name,price,brand,sale,Description,dimensions,color,count_in_stock,ID,Item_package_weight,img  FROM buy WHERE category="accessories"';
            
        }
        else{
        $sql3 =  'SELECT name,price,brand,sale,Description,dimensions,color,count_in_stock,ID,Item_package_weight,img  FROM buy ';
        }
    ...
    //fetch the resulting product = 1 result
...
<body>
    ...
    <section id="pdetails"  class="section-p1">
        <div class="single-pro-image">
            <img src="imgs/display/<?php echo $buy[0][10] ?>.jpg" width="100%" id="MainImg"  alt="">
    
            <?php if($catg==3 or $catg==4){ ?>
            <div class="small-img-group">
                <div class="small-img-col">
                    <img class="smallimg"  src="imgs/display/<?php echo $buy[0][10] ?>_1.jpg" width="100%"  alt=""  >
                </div>
                <div class="small-img-col">
                    <img  class="smallimg" src="imgs/display/<?php echo $buy[0][10] ?>_2.jpg" width="100%"  alt="">
                </div>
                <div class="small-img-col">
                    <img src="imgs/display/<?php echo $buy[0][10] ?>_3.jpg" width="100%" class="smallimg"  alt="">
                </div>
                <div class="small-img-col">
                    <img src="imgs/display/<?php echo $buy[0][10] ?>_4.jpg" width="100%" class="smallimg"  alt="">
                </div>
            </div> <?php } ?>
        </div>

        <div class="single-pro-detail">
                <h6><?php echo '<span > ' . $buy[0][2].  '</span>'; ?></h6> 
                <h4> <?php echo '<span > ' . $buy[0][0].  '</span>'; ?></h4>
                <h2 style="color:#922D4E;"><?php echo '<span >'. $buy[0][1].' </span>';?><p style="color:red; display: inline;">LE</p></h2>
               
                <form id="cart2"  action="CartConnect_search.php" method="post">
                ...
                <span><?php echo $buy[0][2]; ?> Computer entertaiment CFI-ZCT1W <?php echo $buy[0][0]; ?>  <br>
                
                
                <b>Product Description</b>  ‏ : ‎  <?php echo $buy[0][4]; ?>
                <br><b>Product Dimensions</b> ‏ : ‎ <?php echo $buy[0][5]; ?> <br>
                <b>Count in Stock</b> ‏ : ‎ <?php echo $buy[0][7]; ?> ‎  pieces left <br>  
                <b>Item Package Weight</b> ‏ : ‎ <?php echo $buy[0][9]; ?>‎ gm <br>
  ...
  text-shadow: 0 0 5px #09f;
    ...
    <section id="most-saled" class="section-p1">
        ...
        <div class="pro-container" >
            <div class="pro">
                <img src="imgs/display/<?php  $t=rand(0,19); echo $buy2[$t][10]?>.jpg" alt="consile1">
                <div class="des">
                    <span>sony</span>
                    <h5><?php echo  $buy2[$t][0] ; ?></h5>
                    <div class="star">
